export const dataTechs = [
  ...
  {
    title: "Flutter",
    description: "Criação de aplicações mobile utilizando Flutter, focando em desempenho e experiência do usuário multiplataforma.",
    image: "https://storage.googleapis.com/cms-storage-bucket/4fd5520fe28ebf839174.svg"
  },
  {
    title: "HTML",
    description: "Desenvolvimento de interfaces acessíveis e responsivas utilizando HTML5, com integração com frameworks modernos.",
