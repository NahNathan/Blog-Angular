export const dataProjets=[
    ...
    },
    {
        ...
        "title":"Pokédex",
        "description":"Um projeto clássico para vários desenvolvedores. Este projeto foi desenvolvido em Angular e seu principal objetivo foi aprender a como utilizar e consumir APIs externas. O projeto consome a PokémonAPI, e mostra dados do pokémon, assim como possibilitar pesquisar por um pokémon específico.",
