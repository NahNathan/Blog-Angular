export const dataProjects=[
    ...
    },       
    {
        ...
        "description":"Participar da Hackathon IFTM 2024 foi uma experiência incrível e enriquecedora. Foi um desafio intenso que me permitiu aplicar conhecimentos técnicos, trabalhar em equipe sob pressão e desenvolver soluções inovadoras em um ambiente competitivo. A hackathon proporcionou aprendizado prático, networking com outros desenvolvedores e a oportunidade de criar projetos que podem fazer a diferença. Foi uma experiência que agregou muito tanto profissionalmente quanto pessoalmente.",
